class RepositoriesController < ApplicationController
  ...
  def map
    ...
    @go_libs = @go.where(id: @go_deps_repos.pluck(:id))
    @go_tools = @go.where.not(id: @go_deps_repos.pluck(:id))
    ...
    @javascript_libs = @javascript.where(id: @javascript_deps_repos.pluck(:id))
    @javascript_tools = @javascript.where.not(id: @javascript_deps_repos.pluck(:id))
