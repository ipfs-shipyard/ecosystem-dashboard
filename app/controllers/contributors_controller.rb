class ContributorsController < ApplicationController
  def index
    ...
    @issues_scope = Issue.internal.this_period(@range).not_core.humans.unlocked.where("html_url <> ''")
  ...
  def new
    @range = (params[:range].presence || 7).to_i
    @issues_scope = Issue.internal.not_core.humans.unlocked.where("html_url <> ''")
